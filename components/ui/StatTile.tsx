...
export default function StatTile({ icon: Icon, label, value, grad = 'brand' }: StatTileProps) {
    return (
        <div className="glass rounded-card p-3 sm:p-4 shadow-card flex items-center gap-2 sm:gap-3">
            ...
            <div className="min-w-0">
                ...
                <p className="text-ink-muted text-[9px] sm:text-[10px] uppercase tracking-widest font-bold mt-1 leading-tight">{label}</p>
            </div>
        </div>
    );
}
